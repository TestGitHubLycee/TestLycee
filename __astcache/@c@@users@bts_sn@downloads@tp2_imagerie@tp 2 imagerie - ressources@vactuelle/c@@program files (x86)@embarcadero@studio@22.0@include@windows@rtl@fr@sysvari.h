...
#error VARIANT_TVARIANT_SUPPORT non supporté
  #endif
  #if defined(VARIANT_AUTOMATION_SUPPORT)
#error VARIANT_TAUTOMATION_SUPPORT non supporté
  #endif
  #if defined(VARIANT_NATIVE_SUPPORT)
#error VARIANT_NATIVE_SUPPORT non supporté
  #endif
#endif
...
#error ERREUR : sizeof(OleVariant) != sizeof(Variant)
#endif
#if defined(VARIANT_NATIVE_SUPPORT)
  #if sizeof(OleVariant) != sizeof(VARIANT)
#error ERREUR : sizeof(OleVariant) != sizeof(VARIANT)
...
#error ERREUR : sizeof(Variant) != sizeof(VARIANT)
  #endif
#endif
#endif
#if defined(__clang__)
