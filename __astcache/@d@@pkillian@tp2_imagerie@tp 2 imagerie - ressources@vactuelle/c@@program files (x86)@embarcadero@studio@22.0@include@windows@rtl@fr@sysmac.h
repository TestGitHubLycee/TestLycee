...
#error N'incluez pas ce fichier directement.  Incluez 'System.hpp'.
#endif
#if !defined(__cplusplus)
#error sysmac.h ne peut pas être utilisé en mode C - cet en-tête requiert C++ !
#endif
...
#error "NO_STRICT a été défini. L'utilisation du runtime Delphi requiert un substantypage STRICT"
#error "Veuillez consulter 'http://docwiki.embarcadero.com/RADStudio/fr/Les_applications_C%2B%2B_utilisent_le_contrôle_STRICT_des_types'"
    #endif
  #endif
#endif

#if defined(__BORLANDC__) && (__BORLANDC__ < 0x500)
#error BCW 5.0 ou supérieur requis
#endif
...
#error ""System.hpp/sysmac.h et les en-têtes associés nécessitent le support de __declspec(uuid(..)) et de __uuidof"  "
#endif
...
#if (defined(_DELPHI_NEXTGEN) && !defined(_Windows)) || !(defined(_PLAT_MSWINDOWS) || defined(_PLAT_MACOS32))
...
#if __cplusplus >= 201103L && defined(_Windows)
#include <memory>
namespace std {
